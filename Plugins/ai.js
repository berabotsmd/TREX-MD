  ...
  smd(
    ...
    async (message, input) => {
      try {
        ...
        return await message.send(`*Trex Mdʙᴀʀᴅ ᴀɪ:*\n ${result}`, { quoted: message });
      } catch (error) {
    ...
    async (_0x2acf30) => {
      try {
        if (
          ...
          if (
            _0x2acf30.reply_text.includes("Trex Md• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            _0x2dfb59[0].includes("Trex Md • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
