...
smd(
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*TREX MD IS CURRENTLY ACTIVE!*";
 ...
 let tmpUrl = "https://telegra.ph/file/7f5dbbec68a9c6a6b1317.jpg";
 const secmailData = {};
 smd({
   pattern: "tempmail",
